  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <font color="red"><?php echo $row_Doc['s_file']; ?></font>
      </td>
      <td>
      ...
      <td>
        <a class="btn btn-danger btn-block btn-sm" href="doc_open2.php?id=<?php echo $row_Doc['fileID']; ?>" target="_blank">
